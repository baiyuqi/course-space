package com.devd.spring.bookstore.account.service.impl;

import com.devd.spring.bookstore.account.repository.OAuthClientRepository;
import com.devd.spring.bookstore.account.repository.RoleRepository;
import com.devd.spring.bookstore.account.repository.UserRepository;
...
import com.devd.spring.bookstore.account.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
  ...
  public CreateUserResponse registerUser(SignUpRequest signUpRequest) {
    ...
    com.devd.spring.bookstore.account.repository.dao.User user =
        new com.devd.spring.bookstore.account.repository.dao.User(
    ...
    com.devd.spring.bookstore.account.repository.dao.User savedUser =
