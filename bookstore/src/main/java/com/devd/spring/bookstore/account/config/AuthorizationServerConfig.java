package com.devd.spring.bookstore.account.config;
...
import com.devd.spring.bookstore.account.service.AppUserDetailsService;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    JwtAccessTokenConverter jwtAccessTokenConverter = new JwtAccessTokenConverter() {
      ...
      public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        User principal = (User) authentication.getUserAuthentication().getPrincipal();
          Optional<com.devd.spring.bookstore.account.repository.dao.User> userDetail
  ...
  private String getPublicKeyAsString() {
    try {
      return IOUtils.toString(publicKey.getInputStream(), "UTF-8");
    } catch (IOException e) {
